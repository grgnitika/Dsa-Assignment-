...
can share the secret with any number of individuals simultaneously during specific time 
intervals. Each time interval is represented by a tuple (start, end) where start and end are
non-negative integers indicating the start and end times of the interval.
The task is to determine the set of individuals who will eventually know the secret after 
all the possible secret-sharing intervals have occurred.
Example:
...
Given the intervals [(0, 2), (1, 3), (2, 4)], we can observe that during these intervals, 
person 0 shares the secret with every other individual at least once.
...
public class SecretSharing {
    public static List<Integer> eventuallyKnowSecret(int n, int[][] intervals, int firstPerson) {
        ...
        // Adding the first person who initially has the secret
        ...
        for (int[] interval : intervals) {
            ...
            // Sharing the secret to individuals within the current interval
            ...
            // Adding individuals who received the secret during this interval
